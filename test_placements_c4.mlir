module {
  aie.device(npu2) {
    ...
    func.func private @fused_dequant_matvec_v2_bf16(i32, i32, memref<2304xui8>, memref<2048xbf16>, memref<2xbf16>) attributes {link_with = "post_attn_fused_2048k_g32.o"}
    %anm_oout_buf = aie.buffer(%tile_1_2) {sym_name = "anm_oout_buf"} : memref<2048xbf16> 
    func.func private @post_attn_o_out_assemble_bf16(memref<8xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) attributes {link_with = "post_attn_fused_2048k_g32.o"}
    func.func private @post_attn_add_bf16(memref<2048xbf16>, memref<2048xbf16>, memref<2048xbf16>, i32) attributes {link_with = "post_attn_fused_2048k_g32.o"}
    func.func private @post_attn_rms_norm_bf16(memref<2048xbf16>, memref<2048xbf16>, memref<2048xbf16>, i32) attributes {link_with = "post_attn_fused_2048k_g32.o"}
    func.func private @dual_fused_dequant_gemv_bf16(i32, i32, memref<9216xui8>, memref<2048xbf16>, i32) attributes {link_with = "post_attn_fused_2048k_g32.o"}
    func.func private @dual_fused_dequant_gemv_silu_mul_bf16(memref<8xbf16>, i32) attributes {link_with = "post_attn_fused_2048k_g32.o"}
    func.func private @fused_dequant_matvec_down_bf16(i32, i32, memref<9216xui8>, memref<8192xbf16>, memref<2xbf16>) attributes {link_with = "post_attn_fused_2048k_g32.o"}
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c256 step %c1_3 {
            ...
            func.call @fused_dequant_matvec_v2_bf16(%c2_i32, %c0_i32, %3, %1, %5) : (i32, i32, memref<2304xui8>, memref<2048xbf16>, memref<2xbf16>) -> ()
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c256 step %c1_3 {
            ...
            func.call @post_attn_o_out_assemble_bf16(%9, %anm_oout_buf, %7, %c0_i32, %c4_i32, %c2_i32, %c512_i32) : (memref<8xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) -> ()
          ...
          func.call @post_attn_add_bf16(%anm_oout_buf, %1, %4, %c2048_i32) : (memref<2048xbf16>, memref<2048xbf16>, memref<2048xbf16>, i32) -> ()
          %c2048_i32_4 = arith.constant 2048 : i32
          func.call @post_attn_rms_norm_bf16(%4, %2, %6, %c2048_i32_4) : (memref<2048xbf16>, memref<2048xbf16>, memref<2048xbf16>, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c256 step %c1_3 {
            ...
            func.call @dual_fused_dequant_gemv_bf16(%c8_i32, %c0_i32, %3, %1, %c0_i32_4) : (i32, i32, memref<9216xui8>, memref<2048xbf16>, i32) -> ()
            ...
            func.call @dual_fused_dequant_gemv_bf16(%c8_i32_5, %c0_i32_6, %5, %1, %c1_i32) : (i32, i32, memref<9216xui8>, memref<2048xbf16>, i32) -> ()
            aie.objectfifo.release @Agu_0(Consume, 1)
            ...
            func.call @dual_fused_dequant_gemv_silu_mul_bf16(%7, %c8_i32_7) : (memref<8xbf16>, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c256 step %c1_3 {
            ...
            %c2_i32 = arith.constant 2 : i32
            %c0_i32 = arith.constant 0 : i32
            func.call @fused_dequant_matvec_down_bf16(%c2_i32, %c0_i32, %3, %1, %5) : (i32, i32, memref<9216xui8>, memref<8192xbf16>, memref<2xbf16>) -> ()
