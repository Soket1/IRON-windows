...
"""Op wrapper for decode_back_mono (#11.1b/#12 — fused back-half, mono FFN)."""
import numpy as np
...
class AIEDecodeBackMono(AIEOperatorBase):
    ...
    def get_artifacts(self, prefix="decode_back_mono_"):
        ...
        mlir_artifact = PythonGeneratedMLIRArtifact.new(
            ...
            callback_fn="my_decode_back_mono",
    ...
    def set_up_runtime(self):
        ...
        GUD = 2 * PACKED + m * E // 2 + E * 2
        WT_PER_TILE = o_tiles + gu_tiles
        W_BYTES = nc * WT_PER_TILE * R * GUD
        ...
        self.add_kernel("decode_back_mono", self.xclbin_artifact,
                        self.xclbin_artifact.kernel_name, self.insts_artifact)
        self.add_to_runlist("decode_back_mono", "O", "W", "ATTN", "HIN")
