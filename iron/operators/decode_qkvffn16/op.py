...
"""Op wrapper for decode_qkvffn16 — P6.4/50a: QKV(concat)+FFN(reduce) on 16 tiles, 1 dispatch.
Reuses v2 GEMV (.o) + layer_fused relay (.o). See design.py."""
import numpy as np
...
class AIEDecodeQKVFFN16(AIEOperatorBase):
    ...
    def get_artifacts(self, prefix="decode_qkvffn16_"):
        ...
        mlir_artifact = PythonGeneratedMLIRArtifact.new(
            ...
            callback_fn="my_decode_qkvffn16",
    ...
    def set_up_runtime(self):
        pass  # validation drives replay directly (5-BO ABI)
