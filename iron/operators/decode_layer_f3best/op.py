...
class AIEDecodeLayerF3Best(AIEOperatorBase):
    ...
    def get_artifacts(self, prefix="decode_layer_f3best_"):
        ...
        _atrace = '_atrace' if _os.environ.get('F3BEST_AIE_TRACE', '').strip() != '' else ''  # #260: AIE2P hardware trace on score tiles (aie.trace ops)
