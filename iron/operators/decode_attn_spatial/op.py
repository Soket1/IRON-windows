...
"""decode_attn_spatial operator — spatial 8-head 2-stage attention block. Same kernels/ABI
as decode_front_attn (signed v2 GEMV + rope_il INTERLEAVED + flowkv). See design.py."""
import numpy as np
...
class AIEDecodeAttnSpatial(AIEOperatorBase):
    ...
    def get_artifacts(self, prefix="decode_attn_spatial_"):
        ...
        mlir_artifact = PythonGeneratedMLIRArtifact.new(
            ...
            callback_fn="my_decode_attn_spatial",
            callback_args=[
    ...
    def set_up_runtime(self):
        ...
        self.add_buffer("output", ng * q_rows, dtype=bfloat16)
        ...
        self.add_kernel("decode_attn_spatial", self.xclbin_artifact,
                        self.xclbin_artifact.kernel_name, self.insts_artifact)
        self.add_to_runlist("decode_attn_spatial", "output", "packed_weights",
