...
"""Op wrapper for decode_qkvffn1col_fit — P6.4a learning model (one reused join, lowers OK)."""
...
class AIEDecodeQKVFFN1ColFit(AIEOperatorBase):
    ...
    def get_artifacts(self, prefix="decode_qkvffn1col_fit_"):
        ...
        mlir_artifact = PythonGeneratedMLIRArtifact.new(
            ...
            callback_fn="my_decode_qkvffn1col_fit",
