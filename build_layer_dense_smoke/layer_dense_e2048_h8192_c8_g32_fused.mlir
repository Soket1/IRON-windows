module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @bo_L3L2(%shim_noc_tile_3_0, {%mem_tile_6_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    ...
    aie.runtime_sequence(%arg0: memref<1771520xbf16>, %arg1: memref<1179648xbf16>, %arg2: memref<14157824xbf16>, %arg3: memref<2097152xbf16>, %arg4: memref<300032xbf16>) {
      ...
      %25 = aiex.dma_configure_task_for @ffn_out_joined_0 {
      ...
      %26 = aiex.dma_configure_task_for @ffn_out_joined_1 {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<17108992xbf16>, %arg1: memref<2397184xbf16>, %arg2: memref<0xbf16>) {
      aiex.configure @op0_LayerFusedMLIR {
        %subview = memref.subview %arg0[0] [1771520] [1] : memref<17108992xbf16> to memref<1771520xbf16>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [1771520], strides: [1] : memref<1771520xbf16> to memref<1771520xbf16>
        %subview_0 = memref.subview %arg0[1771520] [1179648] [1] : memref<17108992xbf16> to memref<1179648xbf16, strided<[1], offset: 1771520>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [1179648], strides: [1] : memref<1179648xbf16, strided<[1], offset: 1771520>> to memref<1179648xbf16>
        %subview_2 = memref.subview %arg0[2951168] [14157824] [1] : memref<17108992xbf16> to memref<14157824xbf16, strided<[1], offset: 2951168>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [14157824], strides: [1] : memref<14157824xbf16, strided<[1], offset: 2951168>> to memref<14157824xbf16>
        %subview_4 = memref.subview %arg1[0] [2097152] [1] : memref<2397184xbf16> to memref<2097152xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [2097152], strides: [1] : memref<2097152xbf16> to memref<2097152xbf16>
        %subview_6 = memref.subview %arg1[2097152] [300032] [1] : memref<2397184xbf16> to memref<300032xbf16, strided<[1], offset: 2097152>>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [300032], strides: [1] : memref<300032xbf16, strided<[1], offset: 2097152>> to memref<300032xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %reinterpret_cast_7) : (memref<1771520xbf16>, memref<1179648xbf16>, memref<14157824xbf16>, memref<2097152xbf16>, memref<300032xbf16>)
      }
    }
  }
}
