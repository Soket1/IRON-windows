module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @Adp_0(%mem_tile_1_1, {%tile_0_5}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @weight_dp_0(%mem_tile_0_1, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @weight_src_0(%shim_noc_tile_1_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<23040xui8>> 
    aie.objectfifo @weight_qkv_0(%mem_tile_0_1, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    ...
    aie.objectfifo.link [@weight_qkv_0] -> [@Aqkv_0, @Aqkv_1]([] [0, 2304])
    aie.objectfifo @weight_o_0(%mem_tile_0_1, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    ...
    aie.objectfifo.link [@weight_o_0] -> [@Ao_0, @Ao_1]([] [0, 2304])
    aie.objectfifo @weight_gu_0(%mem_tile_0_1, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<9216xui8>> 
    aie.objectfifo @Agu_0(%mem_tile_1_1, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @Agu_1(%mem_tile_1_1, {%tile_1_4}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo.link [@weight_gu_0] -> [@Agu_0, @Agu_1]([] [0, 4608])
    aie.objectfifo.link [@weight_src_0] -> [@weight_qkv_0, @weight_o_0, @weight_gu_0, @weight_dp_0]([] [0, 4608, 9216, 18432])
    aie.objectfifo @Adp_1(%mem_tile_1_1, {%tile_1_5}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo.link [@weight_dp_0] -> [@Adp_0, @Adp_1]([] [0, 2304])
    aie.objectfifo @Adp_2(%mem_tile_3_1, {%tile_2_5}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @weight_dp_1(%mem_tile_4_1, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @weight_src_1(%shim_noc_tile_2_0, {%mem_tile_4_1}, 2 : i32) : !aie.objectfifo<memref<23040xui8>> 
    aie.objectfifo @weight_qkv_1(%mem_tile_4_1, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    ...
    aie.objectfifo.link [@weight_qkv_1] -> [@Aqkv_2, @Aqkv_3]([] [0, 2304])
    aie.objectfifo @weight_o_1(%mem_tile_4_1, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    ...
    aie.objectfifo.link [@weight_o_1] -> [@Ao_2, @Ao_3]([] [0, 2304])
    aie.objectfifo @weight_gu_1(%mem_tile_4_1, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<9216xui8>> 
    aie.objectfifo @Agu_2(%mem_tile_3_1, {%tile_2_4}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @Agu_3(%mem_tile_3_1, {%tile_3_4}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo.link [@weight_gu_1] -> [@Agu_2, @Agu_3]([] [0, 4608])
    aie.objectfifo.link [@weight_src_1] -> [@weight_qkv_1, @weight_o_1, @weight_gu_1, @weight_dp_1]([] [0, 4608, 9216, 18432])
    aie.objectfifo @Adp_3(%mem_tile_3_1, {%tile_3_5}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo.link [@weight_dp_1] -> [@Adp_2, @Adp_3]([] [0, 2304])
    ...
    aie.objectfifo @ffn_out_joined_0(%mem_tile_3_1, {%shim_noc_tile_0_0}, 2 : i32) : !aie.objectfifo<memref<4xbf16>> 
    aie.objectfifo.link [@Cdp_0, @Cdp_1] -> [@ffn_out_joined_0]([0, 2] [])
    aie.objectfifo @Cdp_2(%tile_2_5, {%mem_tile_7_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_3(%tile_3_5, {%mem_tile_7_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @ffn_out_joined_1(%mem_tile_7_1, {%shim_noc_tile_1_0}, 2 : i32) : !aie.objectfifo<memref<4xbf16>> 
    aie.objectfifo.link [@Cdp_2, @Cdp_3] -> [@ffn_out_joined_1]([0, 2] [])
    ...
    aie.objectfifo @o_out_joined_0(%mem_tile_1_1, {%tile_4_4}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    ...
    aie.objectfifo @anm_in(%shim_noc_tile_0_0, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @anm_mem(%mem_tile_1_1, {%tile_4_4}, 2 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo.link [@anm_in] -> [@anm_mem]([] [0])
    aie.objectfifo @bo_L3L2(%shim_noc_tile_0_0, {%mem_tile_6_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @bo_mem(%mem_tile_6_1, {%tile_0_3, %tile_1_3, %tile_2_3, %tile_3_3}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo.link [@bo_L3L2] -> [@bo_mem]([] [0])
    aie.objectfifo @bq_L3L2(%tile_0_2, {%mem_tile_2_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @bq_mem(%mem_tile_2_1, {%tile_1_2, %tile_2_2, %tile_3_2}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo.link [@bq_L3L2] -> [@bq_mem]([] [0])
    aie.objectfifo @ffi_L3L2(%tile_4_4, {%mem_tile_6_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @ffi_mem(%mem_tile_6_1, {%tile_0_4, %tile_1_4, %tile_2_4, %tile_3_4}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    ...
    aie.objectfifo @rms_in(%shim_noc_tile_1_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    ...
    %anm_oout_buf = aie.buffer(%tile_4_4) {sym_name = "anm_oout_buf"} : memref<2048xbf16> 
    ...
    %anm_inpff_buf = aie.buffer(%tile_4_4) {sym_name = "anm_inpff_buf"} : memref<2048xbf16> 
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c256 step %c1_3 {
            ...
            %6 = aie.objectfifo.acquire @o_out_joined_0(Consume, 1) : !aie.objectfifosubview<memref<8xbf16>>
            %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<8xbf16>> -> memref<8xbf16>
            %c0_i32 = arith.constant 0 : i32
            %c4_i32 = arith.constant 4 : i32
            %c2_i32 = arith.constant 2 : i32
            %c512_i32 = arith.constant 512 : i32
            func.call @op0_layer_fused_o_out_assemble_bf16(%7, %anm_oout_buf, %5, %c0_i32, %c4_i32, %c2_i32, %c512_i32) : (memref<8xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) -> ()
    ...
    aie.runtime_sequence(%arg0: memref<1771520xbf16>, %arg1: memref<1179648xbf16>, %arg2: memref<14157824xbf16>, %arg3: memref<2097152xbf16>, %arg4: memref<300032xbf16>) {
      ...
      %2 = aiex.dma_configure_task_for @weight_src_0 {
      ...
      %3 = aiex.dma_configure_task_for @weight_src_1 {
      ...
      %4 = aiex.dma_configure_task_for @weight_src_0 {
        aie.dma_bd(%arg0 : memref<1771520xbf16>, 0, 11520, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 11520, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @weight_src_1 {
        aie.dma_bd(%arg0 : memref<1771520xbf16>, 0, 11520, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 11520, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @Cqkv_0 {
      ...
      %7 = aiex.dma_configure_task_for @Cqkv_1 {
      ...
      %8 = aiex.dma_configure_task_for @Cqkv_2 {
      ...
      %9 = aiex.dma_configure_task_for @Cqkv_3 {
      ...
      %10 = aiex.dma_configure_task_for @Cqkv_0 {
      ...
      %11 = aiex.dma_configure_task_for @Cqkv_1 {
      ...
      %12 = aiex.dma_configure_task_for @Cqkv_2 {
      ...
      %13 = aiex.dma_configure_task_for @Cqkv_3 {
      ...
      %14 = aiex.dma_configure_task_for @bo_L3L2 {
      ...
      %15 = aiex.dma_configure_task_for @anm_in {
        aie.dma_bd(%arg4 : memref<300032xbf16>, 0, 2048, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 2048, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%15)
      %16 = aiex.dma_configure_task_for @anm_in {
      ...
      %17 = aiex.dma_configure_task_for @ffn_out_joined_0 {
      ...
      %18 = aiex.dma_configure_task_for @ffn_out_joined_1 {
