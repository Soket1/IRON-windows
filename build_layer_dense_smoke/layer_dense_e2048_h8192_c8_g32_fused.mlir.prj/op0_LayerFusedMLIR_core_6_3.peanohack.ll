...
13:                                               ; preds = %42, %44, %11
  %14 = phi ptr [ %45, %44 ], [ %43, %42 ], [ @Ao_6_cons_buff_0, %11 ]
  %15 = getelementptr [2304 x i8], ptr %14, i32 0, i32 0
  br label %16

16:                                               ; preds = %13
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %17 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous14, i64 8)
...
18:                                               ; preds = %46, %48, %16
  %19 = phi ptr [ %49, %48 ], [ %47, %46 ], [ @Co_6_buff_0, %16 ]
  %20 = getelementptr [2 x bfloat], ptr %19, i32 0, i32 0
  br label %21

21:                                               ; preds = %18
  call void @op0_layer_fused_o_proj_bf16(i32 2, i32 0, ptr %15, ptr @bo_mem_6_cons_buff_0, ptr %20)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %22 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous14, i64 4)
  %23 = add i32 %22, 1
  %24 = icmp sge i32 %23, 2
  %25 = add i32 %22, -1
  %26 = select i1 %24, i32 %25, i32 %23
  store i32 %26, ptr getelementptr inbounds (i8, ptr @_anonymous14, i64 4)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %27 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous14, i64 8)
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds (i8, ptr @_anonymous14, i64 8)
  %32 = add i64 %9, 1
  br label %8

33:                                               ; preds = %8
  call void @llvm.aie2p.release(i32 52, i32 1)
  %34 = load i32, ptr @_anonymous14
  %35 = add i32 %34, 1
  %36 = icmp sge i32 %35, 1
  %37 = select i1 %36, i32 %34, i32 %35
  store i32 %37, ptr @_anonymous14
  %38 = add i64 %5, 1
  br label %4
...
42:                                               ; preds = %11
  %43 = phi ptr [ @Ao_6_cons_buff_0, %11 ]
  br label %13

44:                                               ; preds = %11
  %45 = phi ptr [ @Ao_6_cons_buff_1, %11 ]
  br label %13

46:                                               ; preds = %16
  %47 = phi ptr [ @Co_6_buff_0, %16 ]
  br label %18

48:                                               ; preds = %16
  %49 = phi ptr [ @Co_6_buff_1, %16 ]
  br label %18
}
