module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @Ao_0(%mem_tile_0_1, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @Ao_1(%mem_tile_0_1, {%tile_1_3}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    ...
    aie.objectfifo.link [@weight_src_0] -> [@Aqkv_0, @Aqkv_1, @Ao_0, @Ao_1, @Agu_0, @Agu_1, @Adp_0, @Adp_1]([] [0, 2304, 4608, 6912, 9216, 13824, 18432, 20736])
    aie.objectfifo @Adp_2(%mem_tile_4_1, {%tile_2_5}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @weight_src_1(%shim_noc_tile_2_0, {%mem_tile_4_1}, 2 : i32) : !aie.objectfifo<memref<23040xui8>> 
    aie.objectfifo @Aqkv_2(%mem_tile_4_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @Aqkv_3(%mem_tile_4_1, {%tile_3_2}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @Ao_2(%mem_tile_4_1, {%tile_2_3}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @Ao_3(%mem_tile_4_1, {%tile_3_3}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @Agu_2(%mem_tile_4_1, {%tile_2_4}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @Agu_3(%mem_tile_4_1, {%tile_3_4}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @Adp_3(%mem_tile_4_1, {%tile_3_5}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo.link [@weight_src_1] -> [@Aqkv_2, @Aqkv_3, @Ao_2, @Ao_3, @Agu_2, @Agu_3, @Adp_2, @Adp_3]([] [0, 2304, 4608, 6912, 9216, 13824, 18432, 20736])
