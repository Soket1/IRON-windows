module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @o_out_anm_0(%mem_tile_0_1, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    aie.objectfifo.link [@o_out_joined_0] -> [@o_out_anm_0]([] [0])
    ...
    aie.objectfifo @o_out_anm_1(%mem_tile_0_1, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    aie.objectfifo.link [@o_out_joined_1] -> [@o_out_anm_1]([] [0])
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c128 step %c1_3 {
            ...
            %8 = aie.objectfifo.acquire @o_out_anm_0(Consume, 1) : !aie.objectfifosubview<memref<8xbf16>>
            ...
            aie.objectfifo.release @o_out_anm_0(Consume, 1)
            %10 = aie.objectfifo.acquire @o_out_anm_1(Consume, 1) : !aie.objectfifosubview<memref<8xbf16>>
            ...
            aie.objectfifo.release @o_out_anm_1(Consume, 1)
          }
