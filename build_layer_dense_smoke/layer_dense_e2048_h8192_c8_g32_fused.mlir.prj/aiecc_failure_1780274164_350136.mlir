module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @o_out_joined_0(%mem_tile_1_1, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    aie.objectfifo @o_out_joined_1(%mem_tile_5_1, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    ...
    aie.objectfifo @o_out_final(%mem_tile_0_1, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<16xbf16>> 
    aie.objectfifo.link [@o_out_joined_0, @o_out_joined_1] -> [@o_out_final]([0, 8] [])
    ...
    func.func private @op0_layer_fused_o_out_assemble_bf16(memref<16xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) attributes {link_with = "op0_layer_fused_2048_8192_g32.o"}
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c128 step %c1_3 {
            ...
            %8 = aie.objectfifo.acquire @o_out_final(Consume, 1) : !aie.objectfifosubview<memref<16xbf16>>
            %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<16xbf16>> -> memref<16xbf16>
            %c0_i32 = arith.constant 0 : i32
            %c8_i32 = arith.constant 8 : i32
            %c2_i32 = arith.constant 2 : i32
            %c256_i32 = arith.constant 256 : i32
            func.call @op0_layer_fused_o_out_assemble_bf16(%9, %anm_oout_buf, %7, %c0_i32, %c8_i32, %c2_i32, %c256_i32) : (memref<16xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) -> ()
            aie.objectfifo.release @o_out_final(Consume, 1)
          }
