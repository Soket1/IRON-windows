module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @bq_L3L2(%tile_0_2, {%mem_tile_1_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @bq_mem(%mem_tile_1_1, {%tile_1_2, %tile_2_2, %tile_3_2}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
