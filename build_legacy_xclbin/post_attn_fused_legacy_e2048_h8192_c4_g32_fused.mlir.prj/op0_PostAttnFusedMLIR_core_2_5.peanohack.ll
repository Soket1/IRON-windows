...
11:                                               ; preds = %8
  ...
  %12 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous11, i64 8)
...
16:                                               ; preds = %13
  ...
  store i32 %20, ptr getelementptr inbounds (i8, ptr @_anonymous11, i64 4)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %21 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous11, i64 8)
  %22 = add i32 %21, 1
  %23 = icmp sge i32 %22, 2
  %24 = add i32 %21, -1
  %25 = select i1 %23, i32 %24, i32 %22
  store i32 %25, ptr getelementptr inbounds (i8, ptr @_anonymous11, i64 8)
  %26 = add i64 %9, 1
  br label %8

27:                                               ; preds = %8
  call void @llvm.aie2p.release(i32 52, i32 1)
  %28 = load i32, ptr @_anonymous11
  %29 = add i32 %28, 1
  %30 = icmp sge i32 %29, 1
  %31 = select i1 %30, i32 %28, i32 %29
  store i32 %31, ptr @_anonymous11
  %32 = add i64 %5, 1
  br label %4
