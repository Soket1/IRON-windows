...
11:                                               ; preds = %8
  ...
  %12 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous12, i64 8), align 4
...
13:                                               ; preds = %36, %38, %11
  %14 = phi ptr [ %39, %38 ], [ %37, %36 ], [ @Cd_3_buff_0, %11 ]
  %15 = getelementptr [2 x bfloat], ptr %14, i32 0, i32 0
  br label %16

16:                                               ; preds = %13
  call void @op0_fused_dequant_matvec_down_bf16(i32 2, i32 0, ptr @Ad_3_cons_buff_0, ptr @silu_mem_3_cons_buff_0, ptr %15)
  ...
  store i32 %20, ptr getelementptr inbounds nuw (i8, ptr @_anonymous12, i64 4), align 4
  call void @llvm.aie2p.release(i32 51, i32 1)
  %21 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous12, i64 8), align 4
  %22 = add i32 %21, 1
  %23 = icmp sge i32 %22, 2
  %24 = add i32 %21, -1
  %25 = select i1 %23, i32 %24, i32 %22
  store i32 %25, ptr getelementptr inbounds nuw (i8, ptr @_anonymous12, i64 8), align 4
  %26 = add i64 %9, 1
  br label %8

27:                                               ; preds = %8
  call void @llvm.aie2p.release(i32 52, i32 1)
  %28 = load i32, ptr @_anonymous12, align 4
  %29 = add i32 %28, 1
  %30 = icmp sge i32 %29, 1
  %31 = select i1 %30, i32 %28, i32 %29
  store i32 %31, ptr @_anonymous12, align 4
  %32 = add i64 %5, 1
  br label %4
...
36:                                               ; preds = %11
  %37 = phi ptr [ @Cd_3_buff_0, %11 ]
  br label %13

38:                                               ; preds = %11
  %39 = phi ptr [ @Cd_3_buff_1, %11 ]
  br label %13
}
