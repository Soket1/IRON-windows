; ModuleID = 'post_attn_fused_legacy_e2048_h8192_c4_g32_fused.mlir.prj\op0_PostAttnFusedMLIR_core_2_2.peanohack.ll'
...
4:                                                ; preds = %4, %2
  ...
  tail call void @op0_dual_fused_dequant_gemv_bf16(i32 8, i32 0, ptr nonnull @Agu_3_cons_buff_0, ptr nonnull @ffi_mem_3_cons_buff_0, i32 0)
  ...
  %8 = zext i1 %7 to i32
  %9 = add i32 %6, %8
  store i32 %9, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 4), align 4
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  tail call void @op0_dual_fused_dequant_gemv_bf16(i32 8, i32 0, ptr nonnull @Agu_3_cons_buff_0, ptr nonnull @ffi_mem_3_cons_buff_0, i32 1)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  %10 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 4), align 4
  %11 = icmp ugt i32 %10, 2147483646
  %12 = zext i1 %11 to i32
  %13 = add i32 %10, %12
  store i32 %13, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 4), align 4
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %14 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 8), align 4
  %cond = icmp eq i32 %14, 1
  %spec.select = select i1 %cond, ptr @Cgu_3_buff_1, ptr @Cgu_3_buff_0
  ...
  tail call void @op0_dual_fused_dequant_gemv_bf16(i32 8, i32 0, ptr nonnull @Agu_3_cons_buff_0, ptr nonnull @ffi_mem_3_cons_buff_0, i32 0)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  %21 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 4), align 4
  ...
  %28 = add i32 %25, %27
  store i32 %28, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 4), align 4
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %29 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 8), align 4
  %cond.1 = icmp eq i32 %29, 1
  %spec.select.1 = select i1 %cond.1, ptr @Cgu_3_buff_1, ptr @Cgu_3_buff_0
  tail call void @op0_dual_fused_dequant_gemv_silu_mul_bf16(ptr nonnull %spec.select.1, i32 8)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  %30 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 8), align 4
  %31 = add i32 %30, 1
  %32 = icmp sgt i32 %31, 1
  %33 = add i32 %30, -1
  %34 = select i1 %32, i32 %33, i32 %31
  store i32 %34, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i20 8), align 4
