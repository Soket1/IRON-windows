...
11:                                               ; preds = %8
  ...
  call void @op0_dual_fused_dequant_gemv_bf16(i32 8, i32 0, ptr @Agu_3_cons_buff_0, ptr @ffi_mem_3_cons_buff_0, i32 0)
  ...
  store i32 %15, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @op0_dual_fused_dequant_gemv_bf16(i32 8, i32 0, ptr @Agu_3_cons_buff_0, ptr @ffi_mem_3_cons_buff_0, i32 1)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %16 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  %17 = add i32 %16, 1
  %18 = icmp sge i32 %17, 1
  %19 = select i1 %18, i32 %16, i32 %17
  store i32 %19, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %20 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 8), align 4
...
21:                                               ; preds = %40, %42, %11
  %22 = phi ptr [ %43, %42 ], [ %41, %40 ], [ @Cgu_3_buff_0, %11 ]
...
24:                                               ; preds = %21
  ...
  %25 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 8), align 4
  %26 = add i32 %25, 1
  %27 = icmp sge i32 %26, 2
  %28 = add i32 %25, -1
  %29 = select i1 %27, i32 %28, i32 %26
  store i32 %29, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 8), align 4
  %30 = add i64 %9, 1
  br label %8

31:                                               ; preds = %8
  call void @llvm.aie2p.release(i32 52, i32 1)
  %32 = load i32, ptr @_anonymous8, align 4
  %33 = add i32 %32, 1
  %34 = icmp sge i32 %33, 1
  %35 = select i1 %34, i32 %32, i32 %33
  store i32 %35, ptr @_anonymous8, align 4
  %36 = add i64 %5, 1
  br label %4
...
40:                                               ; preds = %11
  %41 = phi ptr [ @Cgu_3_buff_0, %11 ]
  br label %21

42:                                               ; preds = %11
  %43 = phi ptr [ @Cgu_3_buff_1, %11 ]
  br label %21
}
