...
21:                                               ; preds = %18
  call void @op0_fused_dequant_matvec_v2_bf16(i32 2, i32 0, ptr %15, ptr @kqv_mem_0_cons_buff_0, ptr %20)
  ...
  %27 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i64 8), align 4
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds nuw (i8, ptr @_anonymous0, i64 8), align 4
  %32 = add i64 %9, 1
  br label %8

33:                                               ; preds = %8
  call void @llvm.aie2p.release(i32 52, i32 1)
  %34 = load i32, ptr @_anonymous0, align 4
  %35 = add i32 %34, 1
  %36 = icmp sge i32 %35, 1
  %37 = select i1 %36, i32 %34, i32 %35
  store i32 %37, ptr @_anonymous0, align 4
  %38 = add i64 %5, 1
  br label %4
