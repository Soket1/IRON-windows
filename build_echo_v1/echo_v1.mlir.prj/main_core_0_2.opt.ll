; ModuleID = 'echo_v1.mlir.prj\main_core_0_2.peanohack.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@in_fifo_cons_buff_1 = external global [256 x bfloat]
@in_fifo_cons_buff_0 = external global [256 x bfloat]
@out_fifo_buff_1 = external global [256 x bfloat]
@out_fifo_buff_0 = external global [256 x bfloat]
...
declare void @echo_copy_bf16(ptr, ptr, i32) local_unnamed_addr
...
2:                                                ; preds = %6, %.preheader3
  ...
  tail call void @echo_copy_bf16(ptr nonnull @in_fifo_cons_buff_0, ptr nonnull @out_fifo_buff_0, i32 256)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @echo_copy_bf16(ptr nonnull @in_fifo_cons_buff_1, ptr nonnull @out_fifo_buff_1, i32 256)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  ...
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  %5 = icmp samesign ult i64 %4, 4294967292
...
9:                                                ; preds = %13, %8
  ...
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  %12 = icmp samesign ult i64 %11, 4294967292
...
.preheader:                                       ; preds = %15, %.preheader.3
  ...
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  %19 = icmp samesign ult i64 %18, 4294967292
