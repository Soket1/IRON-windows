...
declare void @echo_copy_bf16(ptr, ptr, i32)
...
7:                                                ; preds = %4
  ...
  call void @echo_copy_bf16(ptr @in_fifo_cons_buff_0, ptr @out_fifo_buff_0, i32 256)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @echo_copy_bf16(ptr @in_fifo_cons_buff_1, ptr @out_fifo_buff_1, i32 256)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %8 = add i64 %5, 2
  br label %4
