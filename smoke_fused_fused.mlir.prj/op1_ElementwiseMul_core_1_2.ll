...
4:                                                ; preds = %1
  ...
  call void @op1_eltwise_mul_bf16_vector(ptr @in1_4_cons_buff_0, ptr @in2_4_cons_buff_0, ptr @out_4_buff_0, i32 256)
  ...
  call void @llvm.aie2p.acquire(i32 51, i32 -1)
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  call void @op1_eltwise_mul_bf16_vector(ptr @in1_4_cons_buff_1, ptr @in2_4_cons_buff_1, ptr @out_4_buff_1, i32 256)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.release(i32 50, i32 1)
  call void @llvm.aie2p.release(i32 53, i32 1)
  %5 = add i64 %2, 2
