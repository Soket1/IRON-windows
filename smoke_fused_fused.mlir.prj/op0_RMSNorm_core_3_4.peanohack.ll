...
4:                                                ; preds = %1
  ...
  call void @op0_eltwise_mul_bf16_vector(ptr @out1_6_0_cons_buff_0, ptr @in2_weights_0_6_cons_buff_0, ptr @out2_6_0_buff_0, i32 256)
  ...
  call void @llvm.aie2p.acquire(i32 51, i32 -1)
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  call void @op0_eltwise_mul_bf16_vector(ptr @out1_6_0_cons_buff_1, ptr @in2_weights_0_6_cons_buff_1, ptr @out2_6_0_buff_1, i32 256)
  call void @llvm.aie2p.release(i32 50, i32 1)
  call void @llvm.aie2p.release(i32 53, i32 1)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %5 = add i64 %2, 2
