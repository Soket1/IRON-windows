...
4:                                                ; preds = %1
  ...
  call void @op0_rms_norm_bf16_vector(ptr @in1_5_0_cons_buff_0, ptr @out1_5_0_buff_0, i32 256)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @op0_rms_norm_bf16_vector(ptr @in1_5_0_cons_buff_1, ptr @out1_5_0_buff_1, i32 256)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %5 = add i64 %2, 2
  br label %1
