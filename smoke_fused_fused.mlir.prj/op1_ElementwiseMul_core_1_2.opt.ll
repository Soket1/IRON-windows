; ModuleID = 'smoke_fused_fused.mlir.prj\op1_ElementwiseMul_core_1_2.peanohack.ll'
...
1:                                                ; preds = %0, %1
  ...
  tail call void @op1_eltwise_mul_bf16_vector(ptr nonnull @in1_4_cons_buff_0, ptr nonnull @in2_4_cons_buff_0, ptr nonnull @out_4_buff_0, i32 256)
  ...
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @op1_eltwise_mul_bf16_vector(ptr nonnull @in1_4_cons_buff_1, ptr nonnull @in2_4_cons_buff_1, ptr nonnull @out_4_buff_1, i32 256)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 50, i32 1)
  tail call void @llvm.aie2p.release(i32 53, i32 1)
