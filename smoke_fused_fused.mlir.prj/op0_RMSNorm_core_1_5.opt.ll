; ModuleID = 'smoke_fused_fused.mlir.prj\op0_RMSNorm_core_1_5.peanohack.ll'
...
1:                                                ; preds = %0, %1
  ...
  tail call void @op0_rms_norm_bf16_vector(ptr nonnull @in1_7_0_cons_buff_0, ptr nonnull @out1_7_0_buff_0, i32 256)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @op0_rms_norm_bf16_vector(ptr nonnull @in1_7_0_cons_buff_1, ptr nonnull @out1_7_0_buff_1, i32 256)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
