...
define void @core_4_2() {
  ...
  store i32 0, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 12), align 4
  br label %1
...
13:                                               ; preds = %57, %59, %10
  %14 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @o_out_joined_0_cons_buff_0, %10 ]
...
25:                                               ; preds = %61, %63, %65, %23
  %26 = phi ptr [ %66, %65 ], [ %64, %63 ], [ %62, %61 ], [ @anm_in_cons_buff_0, %23 ]
...
30:                                               ; preds = %67, %69, %71, %28
  %31 = phi ptr [ %72, %71 ], [ %70, %69 ], [ %68, %67 ], [ @anm_in_cons_buff_1, %28 ]
...
33:                                               ; preds = %30
  ...
  %34 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 12), align 4
...
35:                                               ; preds = %73, %75, %33
  %36 = phi ptr [ %76, %75 ], [ %74, %73 ], [ @inpff_fifo_buff_0, %33 ]
  %37 = getelementptr [2048 x bfloat], ptr %36, i32 0, i32 0
  br label %38

38:                                               ; preds = %35
  call void @op0_layer_fused_add_bf16(ptr @anm_oout_buf, ptr %27, ptr %37, i32 2048)
  call void @op0_layer_fused_rms_norm2_bf16(ptr %37, ptr %32, ptr @ffi_L3L2_buff_0, i32 2048)
  call void @llvm.aie2p.release(i32 50, i32 2)
  %39 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 4), align 4
  %40 = add i32 %39, 2
  %41 = icmp sge i32 %40, 3
  %42 = add i32 %39, -1
  %43 = select i1 %41, i32 %42, i32 %40
  store i32 %43, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 4), align 4
  ...
  store i32 %47, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 8), align 4
  call void @llvm.aie2p.release(i32 55, i32 1)
  %48 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 12), align 4
  %49 = add i32 %48, 1
  %50 = icmp sge i32 %49, 2
  %51 = add i32 %48, -1
  %52 = select i1 %50, i32 %51, i32 %49
  store i32 %52, ptr getelementptr inbounds nuw (i8, ptr @_anonymous16, i64 12), align 4
  %53 = add i64 %5, 1
  br label %4
...
57:                                               ; preds = %10
  %58 = phi ptr [ @o_out_joined_0_cons_buff_0, %10 ]
  br label %13

59:                                               ; preds = %10
  %60 = phi ptr [ @o_out_joined_0_cons_buff_1, %10 ]
  br label %13

61:                                               ; preds = %23
  %62 = phi ptr [ @anm_in_cons_buff_0, %23 ]
  br label %25

63:                                               ; preds = %23
  %64 = phi ptr [ @anm_in_cons_buff_1, %23 ]
  br label %25

65:                                               ; preds = %23
  %66 = phi ptr [ @anm_in_cons_buff_2, %23 ]
  br label %25

67:                                               ; preds = %28
  %68 = phi ptr [ @anm_in_cons_buff_1, %28 ]
  br label %30

69:                                               ; preds = %28
  %70 = phi ptr [ @anm_in_cons_buff_2, %28 ]
  br label %30

71:                                               ; preds = %28
  %72 = phi ptr [ @anm_in_cons_buff_0, %28 ]
  br label %30

73:                                               ; preds = %33
  %74 = phi ptr [ @inpff_fifo_buff_0, %33 ]
  br label %35

75:                                               ; preds = %33
  %76 = phi ptr [ @inpff_fifo_buff_1, %33 ]
  br label %35
}
