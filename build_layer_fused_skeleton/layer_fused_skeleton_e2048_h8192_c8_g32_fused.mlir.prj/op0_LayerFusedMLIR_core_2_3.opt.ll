; ModuleID = 'layer_fused_skeleton_e2048_h8192_c8_g32_fused.mlir.prj\op0_LayerFusedMLIR_core_2_3.peanohack.ll'
...
4:                                                ; preds = %4, %2
  ...
  tail call void @op0_layer_fused_o_proj_bf16(i32 2, i32 0, ptr nonnull %spec.select, ptr nonnull @bo_mem_2_cons_buff_0, ptr nonnull %8)
  ...
  tail call void @op0_layer_fused_o_proj_bf16(i32 2, i32 0, ptr nonnull %spec.select.1, ptr nonnull @bo_mem_2_cons_buff_0, ptr nonnull %21)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  tail call void @op0_layer_fused_o_proj_bf16(i32 2, i32 0, ptr nonnull %spec.select.2, ptr nonnull @bo_mem_2_cons_buff_0, ptr nonnull %34)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  tail call void @op0_layer_fused_o_proj_bf16(i32 2, i32 0, ptr nonnull %spec.select.3, ptr nonnull @bo_mem_2_cons_buff_0, ptr nonnull %48)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
...
61:                                               ; preds = %4
  ...
  %62 = load i32, ptr @_anonymous6, align 4
  %63 = icmp ugt i32 %62, 2147483646
  %64 = zext i1 %63 to i32
  %65 = add i32 %62, %64
  store i32 %65, ptr @_anonymous6, align 4
