module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @Cdp_0(%tile_0_5, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_1(%tile_1_5, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_2(%tile_2_5, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_3(%tile_3_5, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @ffn_out_joined_0(%mem_tile_1_1, {%tile_4_2}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    ...
    aie.objectfifo @outL_fifo(%tile_4_2, {%shim_noc_tile_4_0}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    ...
    %anm_inpff_buf = aie.buffer(%tile_4_2) {sym_name = "anm_inpff_buf"} : memref<2048xbf16> 
    ...
    %core_4_2 = aie.core(%tile_4_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_5 to %c1024 step %c1_6 {
            %5 = arith.index_cast %arg2 : index to i32
            %6 = aie.objectfifo.acquire @outL_fifo(Produce, 1) : !aie.objectfifosubview<memref<2xbf16>>
            %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<2xbf16>> -> memref<2xbf16>
            %8 = aie.objectfifo.acquire @ffn_out_joined_0(Consume, 1) : !aie.objectfifosubview<memref<8xbf16>>
            %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<8xbf16>> -> memref<8xbf16>
            %c4_i32 = arith.constant 4 : i32
            %c2_i32 = arith.constant 2 : i32
            func.call @op0_layer_fused_sum_partials_add_bf16(%9, %anm_inpff_buf, %7, %5, %c4_i32, %c2_i32) : (memref<8xbf16>, memref<2048xbf16>, memref<2xbf16>, i32, i32, i32) -> ()
