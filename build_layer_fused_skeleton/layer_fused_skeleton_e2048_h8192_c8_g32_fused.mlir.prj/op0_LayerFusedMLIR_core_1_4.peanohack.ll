...
13:                                               ; preds = %52, %54, %11
  %14 = phi ptr [ %55, %54 ], [ %53, %52 ], [ @Agu_1_cons_buff_0, %11 ]
  %15 = getelementptr [4608 x i8], ptr %14, i32 0, i32 0
  br label %16

16:                                               ; preds = %13
  call void @op0_layer_fused_gate_up_bf16(i32 4, i32 0, ptr %15, ptr @ffi_mem_1_cons_buff_0, i32 0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %17 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 4)
  %18 = add i32 %17, 1
  %19 = icmp sge i32 %18, 2
  %20 = add i32 %17, -1
  %21 = select i1 %19, i32 %20, i32 %18
  store i32 %21, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 4)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %22 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 4)
...
23:                                               ; preds = %56, %58, %16
  %24 = phi ptr [ %59, %58 ], [ %57, %56 ], [ @Agu_1_cons_buff_0, %16 ]
  %25 = getelementptr [4608 x i8], ptr %24, i32 0, i32 0
  br label %26

26:                                               ; preds = %23
  call void @op0_layer_fused_gate_up_bf16(i32 4, i32 0, ptr %25, ptr @ffi_mem_1_cons_buff_0, i32 1)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %27 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 4)
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 4)
  %32 = add i64 %9, 1
  br label %8

33:                                               ; preds = %8
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %34 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 8)
...
35:                                               ; preds = %60, %62, %33
  %36 = phi ptr [ %63, %62 ], [ %61, %60 ], [ @inter_1_buff_0, %33 ]
...
38:                                               ; preds = %35
  ...
  %39 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 8)
  %40 = add i32 %39, 1
  %41 = icmp sge i32 %40, 2
  %42 = add i32 %39, -1
  %43 = select i1 %41, i32 %42, i32 %40
  store i32 %43, ptr getelementptr inbounds (i8, ptr @_anonymous9, i64 8)
  call void @llvm.aie2p.release(i32 50, i32 1)
  %44 = load i32, ptr @_anonymous9
  %45 = add i32 %44, 1
  %46 = icmp sge i32 %45, 1
  %47 = select i1 %46, i32 %44, i32 %45
  store i32 %47, ptr @_anonymous9
  %48 = add i64 %5, 1
  br label %4
...
52:                                               ; preds = %11
  %53 = phi ptr [ @Agu_1_cons_buff_0, %11 ]
  br label %13

54:                                               ; preds = %11
  %55 = phi ptr [ @Agu_1_cons_buff_1, %11 ]
  br label %13

56:                                               ; preds = %16
  %57 = phi ptr [ @Agu_1_cons_buff_0, %16 ]
  br label %23

58:                                               ; preds = %16
  %59 = phi ptr [ @Agu_1_cons_buff_1, %16 ]
  br label %23

60:                                               ; preds = %33
  %61 = phi ptr [ @inter_1_buff_0, %33 ]
  br label %35

62:                                               ; preds = %33
  %63 = phi ptr [ @inter_1_buff_1, %33 ]
  br label %35
}
