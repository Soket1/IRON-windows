...
7:                                                ; preds = %4
  call void @llvm.aie2p.acquire(i32 7, i32 -1)
...
9:                                                ; preds = %49, %51, %7
  %10 = phi ptr [ %52, %51 ], [ %50, %49 ], [ @inpff_fifo_buff_0, %7 ]
...
19:                                               ; preds = %53, %55, %16
  %20 = phi ptr [ %56, %55 ], [ %54, %53 ], [ @outL_fifo_buff_0, %16 ]
  %21 = getelementptr [2 x bfloat], ptr %20, i32 0, i32 0
  br label %22

22:                                               ; preds = %19
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %23 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous17, i64 8)
...
24:                                               ; preds = %57, %59, %22
  %25 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @ffn_out_joined_0_cons_buff_0, %22 ]
  %26 = getelementptr [8 x bfloat], ptr %25, i32 0, i32 0
  br label %27

27:                                               ; preds = %24
  call void @op0_layer_fused_sum_partials_add_bf16(ptr %26, ptr %11, ptr %21, i32 %17, i32 4, i32 2)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %28 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous17, i64 8)
  %29 = add i32 %28, 1
  %30 = icmp sge i32 %29, 2
  %31 = add i32 %28, -1
  %32 = select i1 %30, i32 %31, i32 %29
  store i32 %32, ptr getelementptr inbounds (i8, ptr @_anonymous17, i64 8)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %33 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous17, i64 4)
  %34 = add i32 %33, 1
  %35 = icmp sge i32 %34, 2
  %36 = add i32 %33, -1
  %37 = select i1 %35, i32 %36, i32 %34
  store i32 %37, ptr getelementptr inbounds (i8, ptr @_anonymous17, i64 4)
  %38 = add i64 %14, 1
  br label %13

39:                                               ; preds = %13
  call void @llvm.aie2p.release(i32 6, i32 1)
  %40 = load i32, ptr @_anonymous17
  %41 = add i32 %40, 1
  %42 = icmp sge i32 %41, 2
  %43 = add i32 %40, -1
  %44 = select i1 %42, i32 %43, i32 %41
  store i32 %44, ptr @_anonymous17
  %45 = add i64 %5, 1
  br label %4
...
49:                                               ; preds = %7
  %50 = phi ptr [ @inpff_fifo_buff_0, %7 ]
  br label %9

51:                                               ; preds = %7
  %52 = phi ptr [ @inpff_fifo_buff_1, %7 ]
  br label %9

53:                                               ; preds = %16
  %54 = phi ptr [ @outL_fifo_buff_0, %16 ]
  br label %19

55:                                               ; preds = %16
  %56 = phi ptr [ @outL_fifo_buff_1, %16 ]
  br label %19

57:                                               ; preds = %22
  %58 = phi ptr [ @ffn_out_joined_0_cons_buff_0, %22 ]
  br label %24

59:                                               ; preds = %22
  %60 = phi ptr [ @ffn_out_joined_0_cons_buff_1, %22 ]
  br label %24
}
