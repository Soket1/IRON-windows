...
13:                                               ; preds = %42, %44, %11
  %14 = phi ptr [ %45, %44 ], [ %43, %42 ], [ @Ao_3_cons_buff_0, %11 ]
...
18:                                               ; preds = %46, %48, %16
  %19 = phi ptr [ %49, %48 ], [ %47, %46 ], [ @Co_3_buff_0, %16 ]
  %20 = getelementptr [2 x bfloat], ptr %19, i32 0, i32 0
  br label %21

21:                                               ; preds = %18
  call void @op0_layer_fused_o_proj_bf16(i32 2, i32 0, ptr %15, ptr @bo_mem_3_cons_buff_0, ptr %20)
...
33:                                               ; preds = %8
  ...
  %34 = load i32, ptr @_anonymous7
  %35 = add i32 %34, 1
  %36 = icmp sge i32 %35, 1
  %37 = select i1 %36, i32 %34, i32 %35
  store i32 %37, ptr @_anonymous7
  %38 = add i64 %5, 1
  br label %4
...
42:                                               ; preds = %11
  %43 = phi ptr [ @Ao_3_cons_buff_0, %11 ]
  br label %13

44:                                               ; preds = %11
  %45 = phi ptr [ @Ao_3_cons_buff_1, %11 ]
  br label %13

46:                                               ; preds = %16
  %47 = phi ptr [ @Co_3_buff_0, %16 ]
  br label %18

48:                                               ; preds = %16
  %49 = phi ptr [ @Co_3_buff_1, %16 ]
  br label %18
}
