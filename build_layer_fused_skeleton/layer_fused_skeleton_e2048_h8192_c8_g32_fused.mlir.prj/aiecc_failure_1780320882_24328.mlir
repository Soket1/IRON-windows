module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @o_out_joined_0(%mem_tile_1_1, {%tile_4_2}, 2 : i32) : !aie.objectfifo<memref<4xbf16>> 
    aie.objectfifo.link [@Co_0, @Co_1] -> [@o_out_joined_0]([0, 2] [])
    aie.objectfifo @Co_2(%tile_2_3, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Co_3(%tile_3_3, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @o_out_joined_1(%mem_tile_3_1, {%tile_4_2}, 2 : i32) : !aie.objectfifo<memref<4xbf16>> 
    aie.objectfifo.link [@Co_2, @Co_3] -> [@o_out_joined_1]([0, 2] [])
    ...
    func.func private @op0_layer_fused_o_out_assemble_bf16(memref<4xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) attributes {link_with = "op0_layer_fused_2048_8192_g32.o"}
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          scf.for %arg2 = %c0_2 to %c256 step %c1_3 {
            ...
            %8 = aie.objectfifo.acquire @o_out_joined_0(Consume, 1) : !aie.objectfifosubview<memref<4xbf16>>
            %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<4xbf16>> -> memref<4xbf16>
            %c0_i32 = arith.constant 0 : i32
            %c2_i32 = arith.constant 2 : i32
            %c2_i32_5 = arith.constant 2 : i32
            %c512_i32 = arith.constant 512 : i32
            func.call @op0_layer_fused_o_out_assemble_bf16(%9, %anm_oout_buf, %7, %c0_i32, %c2_i32, %c2_i32_5, %c512_i32) : (memref<4xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) -> ()
            aie.objectfifo.release @o_out_joined_0(Consume, 1)
            %10 = aie.objectfifo.acquire @o_out_joined_1(Consume, 1) : !aie.objectfifosubview<memref<4xbf16>>
            %11 = aie.objectfifo.subview.access %10[0] : !aie.objectfifosubview<memref<4xbf16>> -> memref<4xbf16>
            %c2_i32_6 = arith.constant 2 : i32
            %c2_i32_7 = arith.constant 2 : i32
            %c2_i32_8 = arith.constant 2 : i32
            %c512_i32_9 = arith.constant 512 : i32
            func.call @op0_layer_fused_o_out_assemble_bf16(%11, %anm_oout_buf, %7, %c2_i32_6, %c2_i32_7, %c2_i32_8, %c512_i32_9) : (memref<4xbf16>, memref<2048xbf16>, i32, i32, i32, i32, i32) -> ()
