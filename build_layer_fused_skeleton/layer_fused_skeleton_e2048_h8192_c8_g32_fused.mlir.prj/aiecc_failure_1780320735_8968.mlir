module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @bo_L3L2(%shim_noc_tile_3_0, {%mem_tile_3_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @bo_mem(%mem_tile_3_1, {%tile_0_3, %tile_1_3, %tile_2_3, %tile_3_3}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
