module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    %rms_in_prod_lock_0 = aie.lock(%shim_noc_tile_3_0, 4) {init = 0 : i32, sym_name = "rms_in_prod_lock_0"}
    %rms_in_cons_lock_0 = aie.lock(%shim_noc_tile_3_0, 5) {init = 0 : i32, sym_name = "rms_in_cons_lock_0"}
    %outL_fifo_cons_prod_lock_0 = aie.lock(%shim_noc_tile_4_0, 2) {init = 0 : i32, sym_name = "outL_fifo_cons_prod_lock_0"}
    %outL_fifo_cons_cons_lock_0 = aie.lock(%shim_noc_tile_4_0, 3) {init = 0 : i32, sym_name = "outL_fifo_cons_cons_lock_0"}
    %outL_fifo_buff_0 = aie.buffer(%tile_4_3) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "outL_fifo_buff_0"} : memref<2xbf16> 
    %outL_fifo_buff_1 = aie.buffer(%tile_4_3) {address = 1040 : i32, mem_bank = 0 : i32, sym_name = "outL_fifo_buff_1"} : memref<2xbf16> 
    %outL_fifo_prod_lock_0 = aie.lock(%tile_4_3, 2) {init = 2 : i32, sym_name = "outL_fifo_prod_lock_0"}
    %outL_fifo_cons_lock_0 = aie.lock(%tile_4_3, 3) {init = 0 : i32, sym_name = "outL_fifo_cons_lock_0"}
    ...
    %inpff_fifo_buff_0 = aie.buffer(%tile_4_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "inpff_fifo_buff_0"} : memref<2048xbf16> 
    %inpff_fifo_buff_1 = aie.buffer(%tile_4_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "inpff_fifo_buff_1"} : memref<2048xbf16> 
    %inpff_fifo_prod_lock_0 = aie.lock(%tile_4_2, 6) {init = 2 : i32, sym_name = "inpff_fifo_prod_lock_0"}
    %inpff_fifo_cons_lock_0 = aie.lock(%tile_4_2, 7) {init = 0 : i32, sym_name = "inpff_fifo_cons_lock_0"}
    ...
    %ffi_L3L2_cons_buff_0 = aie.buffer(%mem_tile_3_1) {address = 262144 : i32, mem_bank = 4 : i32, sym_name = "ffi_L3L2_cons_buff_0"} : memref<2048xbf16> 
    %ffi_L3L2_cons_prod_lock_0 = aie.lock(%mem_tile_3_1, 10) {init = 1 : i32, sym_name = "ffi_L3L2_cons_prod_lock_0"}
    %ffi_L3L2_cons_cons_lock_0 = aie.lock(%mem_tile_3_1, 11) {init = 0 : i32, sym_name = "ffi_L3L2_cons_cons_lock_0"}
    %ffi_L3L2_buff_0 = aie.buffer(%tile_4_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "ffi_L3L2_buff_0"} : memref<2048xbf16> 
    %ffi_L3L2_prod_lock_0 = aie.lock(%tile_4_2, 4) {init = 1 : i32, sym_name = "ffi_L3L2_prod_lock_0"}
    %ffi_L3L2_cons_lock_0 = aie.lock(%tile_4_2, 5) {init = 0 : i32, sym_name = "ffi_L3L2_cons_lock_0"}
    ...
    %bq_L3L2_cons_buff_0 = aie.buffer(%mem_tile_3_1) {address = 327680 : i32, mem_bank = 5 : i32, sym_name = "bq_L3L2_cons_buff_0"} : memref<2048xbf16> 
    ...
    %bo_L3L2_cons_buff_0 = aie.buffer(%mem_tile_1_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "bo_L3L2_cons_buff_0"} : memref<2048xbf16> 
    %bo_L3L2_cons_prod_lock_0 = aie.lock(%mem_tile_1_1, 12) {init = 1 : i32, sym_name = "bo_L3L2_cons_prod_lock_0"}
    %bo_L3L2_cons_cons_lock_0 = aie.lock(%mem_tile_1_1, 13) {init = 0 : i32, sym_name = "bo_L3L2_cons_cons_lock_0"}
    %bo_L3L2_prod_lock_0 = aie.lock(%shim_noc_tile_3_0, 2) {init = 0 : i32, sym_name = "bo_L3L2_prod_lock_0"}
    %bo_L3L2_cons_lock_0 = aie.lock(%shim_noc_tile_3_0, 3) {init = 0 : i32, sym_name = "bo_L3L2_cons_lock_0"}
    %anm_in_cons_buff_0 = aie.buffer(%tile_4_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "anm_in_cons_buff_0"} : memref<2048xbf16> 
    %anm_in_cons_buff_1 = aie.buffer(%tile_4_2) {address = 5120 : i32, mem_bank = 0 : i32, sym_name = "anm_in_cons_buff_1"} : memref<2048xbf16> 
    %anm_in_cons_buff_2 = aie.buffer(%tile_4_2) {address = 20480 : i32, mem_bank = 1 : i32, sym_name = "anm_in_cons_buff_2"} : memref<2048xbf16> 
    %anm_in_cons_prod_lock_0 = aie.lock(%tile_4_2, 2) {init = 3 : i32, sym_name = "anm_in_cons_prod_lock_0"}
    %anm_in_cons_cons_lock_0 = aie.lock(%tile_4_2, 3) {init = 0 : i32, sym_name = "anm_in_cons_cons_lock_0"}
    %anm_in_prod_lock_0 = aie.lock(%shim_noc_tile_4_0, 0) {init = 0 : i32, sym_name = "anm_in_prod_lock_0"}
    %anm_in_cons_lock_0 = aie.lock(%shim_noc_tile_4_0, 1) {init = 0 : i32, sym_name = "anm_in_cons_lock_0"}
    ...
    %Cqkv_1_cons_prod_lock_0 = aie.lock(%shim_noc_tile_1_0, 4) {init = 0 : i32, sym_name = "Cqkv_1_cons_prod_lock_0"}
    %Cqkv_1_cons_cons_lock_0 = aie.lock(%shim_noc_tile_1_0, 5) {init = 0 : i32, sym_name = "Cqkv_1_cons_cons_lock_0"}
    ...
    %Cqkv_0_cons_prod_lock_0 = aie.lock(%shim_noc_tile_0_0, 4) {init = 0 : i32, sym_name = "Cqkv_0_cons_prod_lock_0"}
    %Cqkv_0_cons_cons_lock_0 = aie.lock(%shim_noc_tile_0_0, 5) {init = 0 : i32, sym_name = "Cqkv_0_cons_cons_lock_0"}
    ...
    %o_out_joined_0_cons_buff_0 = aie.buffer(%tile_4_2) {address = 53248 : i32, mem_bank = 3 : i32, sym_name = "o_out_joined_0_cons_buff_0"} : memref<8xbf16> 
    %o_out_joined_0_cons_buff_1 = aie.buffer(%tile_4_2) {address = 9216 : i32, mem_bank = 0 : i32, sym_name = "o_out_joined_0_cons_buff_1"} : memref<8xbf16> 
    %o_out_joined_0_cons_prod_lock_0 = aie.lock(%tile_4_2, 0) {init = 2 : i32, sym_name = "o_out_joined_0_cons_prod_lock_0"}
    %o_out_joined_0_cons_cons_lock_0 = aie.lock(%tile_4_2, 1) {init = 0 : i32, sym_name = "o_out_joined_0_cons_cons_lock_0"}
    %o_out_joined_0_buff_0 = aie.buffer(%mem_tile_1_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "o_out_joined_0_buff_0"} : memref<8xbf16> 
    %o_out_joined_0_buff_1 = aie.buffer(%mem_tile_1_1) {address = 262144 : i32, mem_bank = 4 : i32, sym_name = "o_out_joined_0_buff_1"} : memref<8xbf16> 
    ...
    %ffn_out_joined_0_cons_buff_0 = aie.buffer(%tile_4_3) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "ffn_out_joined_0_cons_buff_0"} : memref<8xbf16> 
    %ffn_out_joined_0_cons_buff_1 = aie.buffer(%tile_4_3) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "ffn_out_joined_0_cons_buff_1"} : memref<8xbf16> 
    %ffn_out_joined_0_cons_prod_lock_0 = aie.lock(%tile_4_3, 0) {init = 2 : i32, sym_name = "ffn_out_joined_0_cons_prod_lock_0"}
    %ffn_out_joined_0_cons_cons_lock_0 = aie.lock(%tile_4_3, 1) {init = 0 : i32, sym_name = "ffn_out_joined_0_cons_cons_lock_0"}
    %ffn_out_joined_0_buff_0 = aie.buffer(%mem_tile_2_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "ffn_out_joined_0_buff_0"} : memref<8xbf16> 
    %ffn_out_joined_0_buff_1 = aie.buffer(%mem_tile_2_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "ffn_out_joined_0_buff_1"} : memref<8xbf16> 
    %ffn_out_joined_0_prod_lock_0 = aie.lock(%mem_tile_2_1, 8) {init = 2 : i32, sym_name = "ffn_out_joined_0_prod_lock_0"}
    %ffn_out_joined_0_cons_lock_0 = aie.lock(%mem_tile_2_1, 9) {init = 0 : i32, sym_name = "ffn_out_joined_0_cons_lock_0"}
    %ffn_out_joined_0_prod_lock_1 = aie.lock(%mem_tile_2_1, 10) {init = 2 : i32, sym_name = "ffn_out_joined_0_prod_lock_1"}
    %ffn_out_joined_0_cons_lock_1 = aie.lock(%mem_tile_2_1, 11) {init = 0 : i32, sym_name = "ffn_out_joined_0_cons_lock_1"}
    %ffn_out_joined_0_prod_lock_2 = aie.lock(%mem_tile_2_1, 12) {init = 2 : i32, sym_name = "ffn_out_joined_0_prod_lock_2"}
    %ffn_out_joined_0_cons_lock_2 = aie.lock(%mem_tile_2_1, 13) {init = 0 : i32, sym_name = "ffn_out_joined_0_cons_lock_2"}
    %ffn_out_joined_0_prod_lock_3 = aie.lock(%mem_tile_2_1, 14) {init = 2 : i32, sym_name = "ffn_out_joined_0_prod_lock_3"}
    %ffn_out_joined_0_cons_lock_3 = aie.lock(%mem_tile_2_1, 15) {init = 0 : i32, sym_name = "ffn_out_joined_0_cons_lock_3"}
    ...
    %Aqkv_src_1_cons_buff_0 = aie.buffer(%mem_tile_3_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "Aqkv_src_1_cons_buff_0"} : memref<4608xui8> 
    %Aqkv_src_1_cons_buff_1 = aie.buffer(%mem_tile_3_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "Aqkv_src_1_cons_buff_1"} : memref<4608xui8> 
    %Aqkv_src_1_cons_prod_lock_0 = aie.lock(%mem_tile_3_1, 4) {init = 2 : i32, sym_name = "Aqkv_src_1_cons_prod_lock_0"}
    %Aqkv_src_1_cons_cons_lock_0 = aie.lock(%mem_tile_3_1, 5) {init = 0 : i32, sym_name = "Aqkv_src_1_cons_cons_lock_0"}
    %Aqkv_src_1_cons_prod_lock_1 = aie.lock(%mem_tile_3_1, 6) {init = 2 : i32, sym_name = "Aqkv_src_1_cons_prod_lock_1"}
    %Aqkv_src_1_cons_cons_lock_1 = aie.lock(%mem_tile_3_1, 7) {init = 0 : i32, sym_name = "Aqkv_src_1_cons_cons_lock_1"}
    ...
    %Ao_src_1_cons_buff_0 = aie.buffer(%mem_tile_3_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "Ao_src_1_cons_buff_0"} : memref<4608xui8> 
    %Ao_src_1_cons_buff_1 = aie.buffer(%mem_tile_3_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "Ao_src_1_cons_buff_1"} : memref<4608xui8> 
    ...
    aie.flow(%mem_tile_3_1, DMA : 2, %tile_2_2, DMA : 0)
    aie.flow(%shim_noc_tile_1_0, DMA : 1, %mem_tile_3_1, DMA : 1)
    aie.flow(%mem_tile_3_1, DMA : 3, %tile_3_2, DMA : 0)
    aie.flow(%tile_0_5, DMA : 0, %mem_tile_2_1, DMA : 1)
    aie.flow(%tile_1_5, DMA : 0, %mem_tile_2_1, DMA : 2)
    aie.flow(%tile_2_5, DMA : 0, %mem_tile_2_1, DMA : 3)
    aie.flow(%tile_3_5, DMA : 0, %mem_tile_2_1, DMA : 4)
    aie.flow(%mem_tile_2_1, DMA : 4, %tile_4_3, DMA : 0)
    ...
    aie.flow(%mem_tile_1_1, DMA : 2, %tile_4_2, DMA : 0)
    ...
    aie.flow(%shim_noc_tile_4_0, DMA : 0, %tile_4_2, DMA : 1)
    aie.flow(%shim_noc_tile_3_0, DMA : 0, %mem_tile_1_1, DMA : 5)
    aie.flow(%mem_tile_1_1, DMA : 3, %tile_3_3, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 3, %tile_2_3, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 3, %tile_1_3, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 3, %tile_0_3, DMA : 1)
    aie.flow(%tile_0_2, DMA : 1, %mem_tile_3_1, DMA : 2)
    aie.flow(%mem_tile_3_1, DMA : 4, %tile_3_2, DMA : 1)
    aie.flow(%mem_tile_3_1, DMA : 4, %tile_2_2, DMA : 1)
    aie.flow(%mem_tile_3_1, DMA : 4, %tile_1_2, DMA : 1)
    aie.flow(%tile_4_2, DMA : 0, %mem_tile_3_1, DMA : 3)
    aie.flow(%mem_tile_3_1, DMA : 5, %tile_3_4, DMA : 1)
    aie.flow(%mem_tile_3_1, DMA : 5, %tile_2_4, DMA : 1)
    aie.flow(%mem_tile_3_1, DMA : 5, %tile_1_4, DMA : 1)
    aie.flow(%mem_tile_3_1, DMA : 5, %tile_0_4, DMA : 1)
    aie.flow(%tile_4_3, DMA : 0, %shim_noc_tile_4_0, DMA : 0)
    aie.flow(%shim_noc_tile_3_0, DMA : 1, %tile_0_2, DMA : 1)
    ...
    %anm_oout_buf = aie.buffer(%tile_4_2) {address = 36864 : i32, mem_bank = 2 : i32, sym_name = "anm_oout_buf"} : memref<2048xbf16> 
    ...
    %_anonymous16 = aie.buffer(%tile_4_2) {address = 24576 : i32, mem_bank = 1 : i32, sym_name = "_anonymous16"} : memref<4xi32> 
    %core_4_2 = aie.core(%tile_4_2) {
      ...
      %c0 = arith.constant 0 : index
      %c2_i32 = arith.constant 2 : i32
      memref.store %c0_i32, %_anonymous16[%c0] : memref<4xi32>
      memref.store %c0_i32, %_anonymous16[%c1] : memref<4xi32>
      memref.store %c0_i32, %_anonymous16[%c2] : memref<4xi32>
      memref.store %c0_i32, %_anonymous16[%c3] : memref<4xi32>
      cf.br ^bb1(%c0 : index)
    ...
    ^bb2:  // pred: ^bb1
      cf.br ^bb3(%c0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb25
      %3 = arith.cmpi slt, %2, %c4294967295 : index
      cf.cond_br %3, ^bb4, ^bb26
    ^bb4:  // pred: ^bb3
      cf.br ^bb5(%c0 : index)
    ...
    ^bb6:  // pred: ^bb5
      ...
      %7 = memref.load %_anonymous16[%c0] : memref<4xi32>
    ...
    ^bb16(%20: memref<2048xbf16>):  // 4 preds: ^bb12, ^bb13, ^bb14, ^bb15
      %21 = memref.load %_anonymous16[%c1] : memref<4xi32>
    ...
    ^bb21(%24: memref<2048xbf16>):  // 4 preds: ^bb17, ^bb18, ^bb19, ^bb20
      ...
      aie.use_lock(%inpff_fifo_prod_lock_0, AcquireGreaterEqual, 1)
      %25 = memref.load %_anonymous16[%c3] : memref<4xi32>
      %26 = arith.index_cast %25 : i32 to index
      %27 = arith.index_cast %26 : index to i32
      cf.switch %27 : i32, [
        default: ^bb24,
    ...
    ^bb22:  // pred: ^bb21
      cf.br ^bb25(%inpff_fifo_buff_0 : memref<2048xbf16>)
    ^bb23:  // pred: ^bb21
      cf.br ^bb25(%inpff_fifo_buff_1 : memref<2048xbf16>)
    ^bb24:  // pred: ^bb21
      cf.br ^bb25(%inpff_fifo_buff_0 : memref<2048xbf16>)
    ^bb25(%28: memref<2048xbf16>):  // 3 preds: ^bb22, ^bb23, ^bb24
      func.call @op0_layer_fused_add_bf16(%anm_oout_buf, %20, %28, %c2048_i32) : (memref<2048xbf16>, memref<2048xbf16>, memref<2048xbf16>, i32) -> ()
      func.call @op0_layer_fused_rms_norm2_bf16(%28, %24, %ffi_L3L2_buff_0, %c2048_i32) : (memref<2048xbf16>, memref<2048xbf16>, memref<2048xbf16>, i32) -> ()
      aie.use_lock(%anm_in_cons_prod_lock_0, Release, 2)
      %29 = memref.load %_anonymous16[%c1] : memref<4xi32>
      %30 = arith.addi %29, %c2_i32 : i32
      %31 = arith.cmpi sge, %30, %c3_i32 : i32
      %32 = arith.subi %30, %c3_i32 : i32
      %33 = arith.select %31, %32, %30 : i32
      memref.store %33, %_anonymous16[%c1] : memref<4xi32>
      aie.use_lock(%ffi_L3L2_cons_lock_0, Release, 1)
      %34 = memref.load %_anonymous16[%c2] : memref<4xi32>
      %35 = arith.addi %34, %c1_i32 : i32
      %36 = arith.cmpi sge, %35, %c1_i32 : i32
      %37 = arith.select %36, %34, %35 : i32
      memref.store %37, %_anonymous16[%c2] : memref<4xi32>
      aie.use_lock(%inpff_fifo_cons_lock_0, Release, 1)
      %38 = memref.load %_anonymous16[%c3] : memref<4xi32>
      %39 = arith.addi %38, %c1_i32 : i32
      %40 = arith.cmpi sge, %39, %c2_i32 : i32
      %41 = arith.subi %39, %c2_i32 : i32
      %42 = arith.select %40, %41, %39 : i32
      memref.store %42, %_anonymous16[%c3] : memref<4xi32>
    ...
    %_anonymous17 = aie.buffer(%tile_4_3) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "_anonymous17"} : memref<3xi32> 
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb19
      ...
      cf.cond_br %3, ^bb4, ^bb20
    ^bb4:  // pred: ^bb3
      aie.use_lock(%inpff_fifo_cons_lock_0, AcquireGreaterEqual, 1)
    ...
    ^bb5:  // pred: ^bb4
      cf.br ^bb8(%inpff_fifo_buff_0 : memref<2048xbf16>)
    ^bb6:  // pred: ^bb4
      cf.br ^bb8(%inpff_fifo_buff_1 : memref<2048xbf16>)
    ^bb7:  // pred: ^bb4
      cf.br ^bb8(%inpff_fifo_buff_0 : memref<2048xbf16>)
    ^bb8(%7: memref<2048xbf16>):  // 3 preds: ^bb5, ^bb6, ^bb7
      cf.br ^bb9(%c0 : index)
    ...
    ^bb10:  // pred: ^bb9
      ...
      aie.use_lock(%outL_fifo_prod_lock_0, AcquireGreaterEqual, 1)
      %11 = memref.load %_anonymous17[%c1] : memref<3xi32>
    ...
    ^bb11:  // pred: ^bb10
      cf.br ^bb14(%outL_fifo_buff_0 : memref<2xbf16>)
    ^bb12:  // pred: ^bb10
      cf.br ^bb14(%outL_fifo_buff_1 : memref<2xbf16>)
    ^bb13:  // pred: ^bb10
      cf.br ^bb14(%outL_fifo_buff_0 : memref<2xbf16>)
    ^bb14(%14: memref<2xbf16>):  // 3 preds: ^bb11, ^bb12, ^bb13
      aie.use_lock(%ffn_out_joined_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
    ...
    ^bb15:  // pred: ^bb14
      cf.br ^bb18(%ffn_out_joined_0_cons_buff_0 : memref<8xbf16>)
    ^bb16:  // pred: ^bb14
      cf.br ^bb18(%ffn_out_joined_0_cons_buff_1 : memref<8xbf16>)
    ^bb17:  // pred: ^bb14
      cf.br ^bb18(%ffn_out_joined_0_cons_buff_0 : memref<8xbf16>)
    ^bb18(%18: memref<8xbf16>):  // 3 preds: ^bb15, ^bb16, ^bb17
      func.call @op0_layer_fused_sum_partials_add_bf16(%18, %7, %14, %10, %c4_i32, %c2_i32) : (memref<8xbf16>, memref<2048xbf16>, memref<2xbf16>, i32, i32, i32) -> ()
      aie.use_lock(%ffn_out_joined_0_cons_prod_lock_0, Release, 1)
      ...
      aie.use_lock(%outL_fifo_cons_lock_0, Release, 1)
      %24 = memref.load %_anonymous17[%c1] : memref<3xi32>
      %25 = arith.addi %24, %c1_i32 : i32
      %26 = arith.cmpi sge, %25, %c2_i32 : i32
      %27 = arith.subi %25, %c2_i32 : i32
      %28 = arith.select %26, %27, %25 : i32
      memref.store %28, %_anonymous17[%c1] : memref<3xi32>
      %29 = arith.addi %8, %c1 : index
      cf.br ^bb9(%29 : index)
    ^bb19:  // pred: ^bb9
      aie.use_lock(%inpff_fifo_prod_lock_0, Release, 1)
      %30 = memref.load %_anonymous17[%c0] : memref<3xi32>
      %31 = arith.addi %30, %c1_i32 : i32
      %32 = arith.cmpi sge, %31, %c2_i32 : i32
      %33 = arith.subi %31, %c2_i32 : i32
      %34 = arith.select %32, %33, %31 : i32
      memref.store %34, %_anonymous17[%c0] : memref<3xi32>
      %35 = arith.addi %2, %c1 : index
      cf.br ^bb3(%35 : index)
    ^bb20:  // pred: ^bb3
    ...
    aie.runtime_sequence(%arg0: memref<1771520xbf16>, %arg1: memref<1179648xbf16>, %arg2: memref<14157824xbf16>, %arg3: memref<2097152xbf16>, %arg4: memref<300032xbf16>) {
      ...
      %25 = aiex.dma_configure_task_for @outL_fifo_shim_alloc {
    ...
    ^bb22:  // 2 preds: ^bb21, ^bb23
      ...
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 0, 2) {bd_id = 28 : i32, next_bd_id = 29 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_0, Release, 1)
      aie.next_bd ^bb23
    ^bb23:  // pred: ^bb22
      aie.use_lock(%ffn_out_joined_0_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 0, 2) {bd_id = 29 : i32, next_bd_id = 28 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_0, Release, 1)
      aie.next_bd ^bb22
    ^bb24:  // pred: ^bb21
    ...
    ^bb25:  // 2 preds: ^bb24, ^bb26
      ...
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 2, 2) {bd_id = 12 : i32, next_bd_id = 13 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_1, Release, 1)
      aie.next_bd ^bb26
    ^bb26:  // pred: ^bb25
      aie.use_lock(%ffn_out_joined_0_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 2, 2) {bd_id = 13 : i32, next_bd_id = 12 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_1, Release, 1)
      aie.next_bd ^bb25
    ^bb27:  // pred: ^bb24
      %7 = aie.dma_start(S2MM, 3, ^bb28, ^bb30)
    ^bb28:  // 2 preds: ^bb27, ^bb29
      aie.use_lock(%ffn_out_joined_0_prod_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 4, 2) {bd_id = 30 : i32, next_bd_id = 31 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_2, Release, 1)
      aie.next_bd ^bb29
    ^bb29:  // pred: ^bb28
      aie.use_lock(%ffn_out_joined_0_prod_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 4, 2) {bd_id = 31 : i32, next_bd_id = 30 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_2, Release, 1)
      aie.next_bd ^bb28
    ^bb30:  // pred: ^bb27
      %8 = aie.dma_start(S2MM, 4, ^bb31, ^bb33)
    ^bb31:  // 2 preds: ^bb30, ^bb32
      aie.use_lock(%ffn_out_joined_0_prod_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 6, 2) {bd_id = 14 : i32, next_bd_id = 15 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_3, Release, 1)
      aie.next_bd ^bb32
    ^bb32:  // pred: ^bb31
      aie.use_lock(%ffn_out_joined_0_prod_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 6, 2) {bd_id = 15 : i32, next_bd_id = 14 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_lock_3, Release, 1)
      aie.next_bd ^bb31
    ^bb33:  // pred: ^bb30
    ...
    ^bb34:  // 2 preds: ^bb33, ^bb41
      ...
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 0, 2) {bd_id = 16 : i32, next_bd_id = 17 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_0, Release, 1)
      aie.next_bd ^bb35
    ^bb35:  // pred: ^bb34
      aie.use_lock(%ffn_out_joined_0_cons_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 2, 2) {bd_id = 17 : i32, next_bd_id = 18 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_1, Release, 1)
      aie.next_bd ^bb36
    ^bb36:  // pred: ^bb35
      aie.use_lock(%ffn_out_joined_0_cons_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 4, 2) {bd_id = 18 : i32, next_bd_id = 19 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_2, Release, 1)
      aie.next_bd ^bb37
    ^bb37:  // pred: ^bb36
      aie.use_lock(%ffn_out_joined_0_cons_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_0 : memref<8xbf16>, 6, 2) {bd_id = 19 : i32, next_bd_id = 20 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_3, Release, 1)
      aie.next_bd ^bb38
    ^bb38:  // pred: ^bb37
      aie.use_lock(%ffn_out_joined_0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 0, 2) {bd_id = 20 : i32, next_bd_id = 21 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_0, Release, 1)
      aie.next_bd ^bb39
    ^bb39:  // pred: ^bb38
      aie.use_lock(%ffn_out_joined_0_cons_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 2, 2) {bd_id = 21 : i32, next_bd_id = 22 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_1, Release, 1)
      aie.next_bd ^bb40
    ^bb40:  // pred: ^bb39
      aie.use_lock(%ffn_out_joined_0_cons_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 4, 2) {bd_id = 22 : i32, next_bd_id = 23 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_2, Release, 1)
      aie.next_bd ^bb41
    ^bb41:  // pred: ^bb40
      aie.use_lock(%ffn_out_joined_0_cons_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_buff_1 : memref<8xbf16>, 6, 2) {bd_id = 23 : i32, next_bd_id = 16 : i32}
      aie.use_lock(%ffn_out_joined_0_prod_lock_3, Release, 1)
      aie.next_bd ^bb34
    ^bb42:  // pred: ^bb33
      aie.end
    ...
    ^bb31:  // pred: ^bb30
      ...
      aie.next_bd ^bb24
    ^bb32:  // pred: ^bb23
      %8 = aie.dma_start(S2MM, 5, ^bb33, ^bb34)
    ^bb33:  // 2 preds: ^bb32, ^bb33
      aie.use_lock(%bo_L3L2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%bo_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 30 : i32, next_bd_id = 30 : i32}
      aie.use_lock(%bo_L3L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb33
    ^bb34:  // pred: ^bb32
      %9 = aie.dma_start(MM2S, 3, ^bb35, ^bb36)
    ^bb35:  // 2 preds: ^bb34, ^bb35
      aie.use_lock(%bo_L3L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%bo_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 31 : i32, next_bd_id = 31 : i32}
    ...
    ^bb10:  // pred: ^bb9
      ...
      aie.next_bd ^bb9
    ^bb11:  // pred: ^bb8
      %3 = aie.dma_start(MM2S, 2, ^bb12, ^bb14)
    ^bb12:  // 2 preds: ^bb11, ^bb13
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_0 : memref<4608xui8>, 0, 2304) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb13
    ^bb13:  // pred: ^bb12
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_1 : memref<4608xui8>, 0, 2304) {bd_id = 7 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb12
    ^bb14:  // pred: ^bb11
      %4 = aie.dma_start(S2MM, 1, ^bb15, ^bb19)
    ^bb15:  // 2 preds: ^bb14, ^bb18
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_0 : memref<4608xui8>, 0, 2304) {bd_id = 26 : i32, next_bd_id = 27 : i32}
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb16
    ^bb16:  // pred: ^bb15
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_0 : memref<4608xui8>, 2304, 2304) {bd_id = 27 : i32, next_bd_id = 28 : i32}
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_1, Release, 1)
      aie.next_bd ^bb17
    ^bb17:  // pred: ^bb16
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_1 : memref<4608xui8>, 0, 2304) {bd_id = 28 : i32, next_bd_id = 29 : i32}
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb18
    ^bb18:  // pred: ^bb17
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_1 : memref<4608xui8>, 2304, 2304) {bd_id = 29 : i32, next_bd_id = 26 : i32}
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_1, Release, 1)
      aie.next_bd ^bb15
    ^bb19:  // pred: ^bb14
      %5 = aie.dma_start(MM2S, 3, ^bb20, ^bb22)
    ^bb20:  // 2 preds: ^bb19, ^bb21
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_0 : memref<4608xui8>, 2304, 2304) {bd_id = 30 : i32, next_bd_id = 31 : i32}
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_1, Release, 1)
      aie.next_bd ^bb21
    ^bb21:  // pred: ^bb20
      aie.use_lock(%Aqkv_src_1_cons_cons_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Aqkv_src_1_cons_buff_1 : memref<4608xui8>, 2304, 2304) {bd_id = 31 : i32, next_bd_id = 30 : i32}
      aie.use_lock(%Aqkv_src_1_cons_prod_lock_1, Release, 1)
      aie.next_bd ^bb20
    ^bb22:  // pred: ^bb19
      %6 = aie.dma_start(S2MM, 2, ^bb23, ^bb24)
    ^bb23:  // 2 preds: ^bb22, ^bb23
      aie.use_lock(%bq_L3L2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%bq_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 8 : i32, next_bd_id = 8 : i32}
      aie.use_lock(%bq_L3L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb23
    ^bb24:  // pred: ^bb22
      %7 = aie.dma_start(MM2S, 4, ^bb25, ^bb26)
    ^bb25:  // 2 preds: ^bb24, ^bb25
      aie.use_lock(%bq_L3L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%bq_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 9 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%bq_L3L2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb25
    ^bb26:  // pred: ^bb24
      %8 = aie.dma_start(S2MM, 3, ^bb27, ^bb28)
    ^bb27:  // 2 preds: ^bb26, ^bb27
      aie.use_lock(%ffi_L3L2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffi_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 32 : i32, next_bd_id = 32 : i32}
      aie.use_lock(%ffi_L3L2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb27
    ^bb28:  // pred: ^bb26
      %9 = aie.dma_start(MM2S, 5, ^bb29, ^bb30)
    ^bb29:  // 2 preds: ^bb28, ^bb29
      aie.use_lock(%ffi_L3L2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffi_L3L2_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 33 : i32, next_bd_id = 33 : i32}
    ...
    %mem_4_3 = aie.mem(%tile_4_3) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%ffn_out_joined_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_cons_buff_0 : memref<8xbf16>, 0, 8) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%ffn_out_joined_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%ffn_out_joined_0_cons_buff_1 : memref<8xbf16>, 0, 8) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%ffn_out_joined_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb4, ^bb6)
    ^bb4:  // 2 preds: ^bb3, ^bb5
      aie.use_lock(%outL_fifo_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%outL_fifo_buff_0 : memref<2xbf16>, 0, 2) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%outL_fifo_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%outL_fifo_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%outL_fifo_buff_1 : memref<2xbf16>, 0, 2) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%outL_fifo_prod_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      aie.end
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb6
      ...
      aie.dma_bd(%anm_in_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%anm_in_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%anm_in_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%anm_in_cons_buff_1 : memref<2048xbf16>, 0, 2048) {bd_id = 3 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%anm_in_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb6:  // pred: ^bb5
      aie.use_lock(%anm_in_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%anm_in_cons_buff_2 : memref<2048xbf16>, 0, 2048) {bd_id = 4 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%anm_in_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb7:  // pred: ^bb3
    ...
    aie.shim_dma_allocation @Cqkv_0_shim_alloc(%shim_noc_tile_0_0, S2MM, 0)
    aie.shim_dma_allocation @Cqkv_1_shim_alloc(%shim_noc_tile_1_0, S2MM, 0)
    ...
    aie.shim_dma_allocation @anm_in_shim_alloc(%shim_noc_tile_4_0, MM2S, 0)
    aie.shim_dma_allocation @bo_L3L2_shim_alloc(%shim_noc_tile_3_0, MM2S, 0)
    aie.shim_dma_allocation @outL_fifo_shim_alloc(%shim_noc_tile_4_0, S2MM, 0)
    aie.shim_dma_allocation @rms_in_shim_alloc(%shim_noc_tile_3_0, MM2S, 1)
    aie.packet_flow(15) {
