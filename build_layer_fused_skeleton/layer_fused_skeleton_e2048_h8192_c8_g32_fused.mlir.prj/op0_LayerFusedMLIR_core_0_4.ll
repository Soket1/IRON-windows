...
16:                                               ; preds = %13
  ...
  %17 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  %18 = add i32 %17, 1
  %19 = icmp sge i32 %18, 2
  %20 = add i32 %17, -1
  %21 = select i1 %19, i32 %20, i32 %18
  store i32 %21, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %22 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
...
26:                                               ; preds = %23
  ...
  call void @llvm.aie2p.release(i32 48, i32 1)
  %27 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 4), align 4
  %32 = add i64 %9, 1
  br label %8

33:                                               ; preds = %8
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %34 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous8, i64 8), align 4
