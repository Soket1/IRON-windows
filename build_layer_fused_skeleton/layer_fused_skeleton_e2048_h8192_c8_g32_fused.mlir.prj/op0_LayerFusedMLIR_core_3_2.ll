...
13:                                               ; preds = %92, %94, %11
  %14 = phi ptr [ %95, %94 ], [ %93, %92 ], [ @Aqkv_3_cons_buff_0, %11 ]
...
18:                                               ; preds = %96, %98, %16
  %19 = phi ptr [ %99, %98 ], [ %97, %96 ], [ @Cqkv_3_buff_0, %16 ]
  %20 = getelementptr [2 x bfloat], ptr %19, i32 0, i32 0
  br label %21

21:                                               ; preds = %18
  call void @op0_layer_fused_qkv_gemv_bf16(i32 2, i32 0, ptr %15, ptr @bq_mem_2_cons_buff_0, ptr %20)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %22 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
  %23 = add i32 %22, 1
  %24 = icmp sge i32 %23, 2
  %25 = add i32 %22, -1
  %26 = select i1 %24, i32 %25, i32 %23
  store i32 %26, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
  call void @llvm.aie2p.release(i32 51, i32 1)
  %27 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
  %32 = add i64 %9, 1
  br label %8
...
36:                                               ; preds = %33
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %37 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
...
38:                                               ; preds = %100, %102, %36
  %39 = phi ptr [ %103, %102 ], [ %101, %100 ], [ @Aqkv_3_cons_buff_0, %36 ]
  %40 = getelementptr [2304 x i8], ptr %39, i32 0, i32 0
  br label %41

41:                                               ; preds = %38
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %42 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
...
43:                                               ; preds = %104, %106, %41
  %44 = phi ptr [ %107, %106 ], [ %105, %104 ], [ @Cqkv_3_buff_0, %41 ]
  %45 = getelementptr [2 x bfloat], ptr %44, i32 0, i32 0
  br label %46

46:                                               ; preds = %43
  call void @op0_layer_fused_qkv_gemv_bf16(i32 2, i32 0, ptr %40, ptr @bq_mem_2_cons_buff_0, ptr %45)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %47 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
  %48 = add i32 %47, 1
  %49 = icmp sge i32 %48, 2
  %50 = add i32 %47, -1
  %51 = select i1 %49, i32 %50, i32 %48
  store i32 %51, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
  call void @llvm.aie2p.release(i32 51, i32 1)
  ...
  store i32 %56, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
  %57 = add i64 %34, 1
  br label %33
...
61:                                               ; preds = %58
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %62 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
...
63:                                               ; preds = %108, %110, %61
  %64 = phi ptr [ %111, %110 ], [ %109, %108 ], [ @Aqkv_3_cons_buff_0, %61 ]
  %65 = getelementptr [2304 x i8], ptr %64, i32 0, i32 0
  br label %66

66:                                               ; preds = %63
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %67 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
...
68:                                               ; preds = %112, %114, %66
  %69 = phi ptr [ %115, %114 ], [ %113, %112 ], [ @Cqkv_3_buff_0, %66 ]
  %70 = getelementptr [2 x bfloat], ptr %69, i32 0, i32 0
  br label %71

71:                                               ; preds = %68
  call void @op0_layer_fused_qkv_gemv_bf16(i32 2, i32 0, ptr %65, ptr @bq_mem_2_cons_buff_0, ptr %70)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %72 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
  %73 = add i32 %72, 1
  %74 = icmp sge i32 %73, 2
  %75 = add i32 %72, -1
  %76 = select i1 %74, i32 %75, i32 %73
  store i32 %76, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 4), align 4
  call void @llvm.aie2p.release(i32 51, i32 1)
  %77 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
  %78 = add i32 %77, 1
  %79 = icmp sge i32 %78, 2
  %80 = add i32 %77, -1
  %81 = select i1 %79, i32 %80, i32 %78
  store i32 %81, ptr getelementptr inbounds nuw (i8, ptr @_anonymous3, i64 8), align 4
  %82 = add i64 %59, 1
  br label %58

83:                                               ; preds = %58
  call void @llvm.aie2p.release(i32 52, i32 1)
  %84 = load i32, ptr @_anonymous3, align 4
  %85 = add i32 %84, 1
  %86 = icmp sge i32 %85, 1
  %87 = select i1 %86, i32 %84, i32 %85
  store i32 %87, ptr @_anonymous3, align 4
  %88 = add i64 %5, 1
  br label %4
...
92:                                               ; preds = %11
  %93 = phi ptr [ @Aqkv_3_cons_buff_0, %11 ]
  br label %13

94:                                               ; preds = %11
  %95 = phi ptr [ @Aqkv_3_cons_buff_1, %11 ]
  br label %13

96:                                               ; preds = %16
  %97 = phi ptr [ @Cqkv_3_buff_0, %16 ]
  br label %18

98:                                               ; preds = %16
  %99 = phi ptr [ @Cqkv_3_buff_1, %16 ]
  br label %18

100:                                              ; preds = %36
  %101 = phi ptr [ @Aqkv_3_cons_buff_0, %36 ]
  br label %38

102:                                              ; preds = %36
  %103 = phi ptr [ @Aqkv_3_cons_buff_1, %36 ]
  br label %38

104:                                              ; preds = %41
  %105 = phi ptr [ @Cqkv_3_buff_0, %41 ]
  br label %43

106:                                              ; preds = %41
  %107 = phi ptr [ @Cqkv_3_buff_1, %41 ]
  br label %43

108:                                              ; preds = %61
  %109 = phi ptr [ @Aqkv_3_cons_buff_0, %61 ]
  br label %63

110:                                              ; preds = %61
  %111 = phi ptr [ @Aqkv_3_cons_buff_1, %61 ]
  br label %63

112:                                              ; preds = %66
  %113 = phi ptr [ @Cqkv_3_buff_0, %66 ]
  br label %68

114:                                              ; preds = %66
  %115 = phi ptr [ @Cqkv_3_buff_1, %66 ]
  br label %68
}
