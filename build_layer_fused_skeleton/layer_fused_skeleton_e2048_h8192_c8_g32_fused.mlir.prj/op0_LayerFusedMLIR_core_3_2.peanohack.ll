...
16:                                               ; preds = %13
  ...
  %17 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
...
21:                                               ; preds = %18
  ...
  %22 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
  %23 = add i32 %22, 1
  %24 = icmp sge i32 %23, 2
  %25 = add i32 %22, -1
  %26 = select i1 %24, i32 %25, i32 %23
  store i32 %26, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %27 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
  %32 = add i64 %9, 1
  br label %8
...
36:                                               ; preds = %33
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %37 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
...
41:                                               ; preds = %38
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %42 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
...
46:                                               ; preds = %43
  ...
  call void @llvm.aie2p.release(i32 48, i32 1)
  %47 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
  %48 = add i32 %47, 1
  %49 = icmp sge i32 %48, 2
  %50 = add i32 %47, -1
  %51 = select i1 %49, i32 %50, i32 %48
  store i32 %51, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %52 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
  %53 = add i32 %52, 1
  %54 = icmp sge i32 %53, 2
  %55 = add i32 %52, -1
  %56 = select i1 %54, i32 %55, i32 %53
  store i32 %56, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
  %57 = add i64 %34, 1
  br label %33
...
61:                                               ; preds = %58
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %62 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
...
66:                                               ; preds = %63
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %67 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
...
71:                                               ; preds = %68
  ...
  call void @llvm.aie2p.release(i32 48, i32 1)
  %72 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
  %73 = add i32 %72, 1
  %74 = icmp sge i32 %73, 2
  %75 = add i32 %72, -1
  %76 = select i1 %74, i32 %75, i32 %73
  store i32 %76, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 4)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %77 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
  %78 = add i32 %77, 1
  %79 = icmp sge i32 %78, 2
  %80 = add i32 %77, -1
  %81 = select i1 %79, i32 %80, i32 %78
  store i32 %81, ptr getelementptr inbounds (i8, ptr @_anonymous3, i64 8)
  %82 = add i64 %59, 1
  br label %58

83:                                               ; preds = %58
  call void @llvm.aie2p.release(i32 52, i32 1)
  %84 = load i32, ptr @_anonymous3
  %85 = add i32 %84, 1
  %86 = icmp sge i32 %85, 1
  %87 = select i1 %86, i32 %84, i32 %85
  store i32 %87, ptr @_anonymous3
  %88 = add i64 %5, 1
  br label %4
