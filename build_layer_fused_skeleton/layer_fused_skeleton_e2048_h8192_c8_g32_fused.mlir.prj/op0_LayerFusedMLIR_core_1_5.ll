...
9:                                                ; preds = %48, %50, %7
  %10 = phi ptr [ %51, %50 ], [ %49, %48 ], [ @inter_1_buff_0, %7 ]
...
16:                                               ; preds = %13
  ...
  %17 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous13, i64 4), align 4
...
18:                                               ; preds = %52, %54, %16
  %19 = phi ptr [ %55, %54 ], [ %53, %52 ], [ @Adp_1_cons_buff_0, %16 ]
...
23:                                               ; preds = %56, %58, %21
  %24 = phi ptr [ %59, %58 ], [ %57, %56 ], [ @Cdp_1_buff_0, %21 ]
...
26:                                               ; preds = %23
  ...
  %27 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous13, i64 4), align 4
  %28 = add i32 %27, 1
  %29 = icmp sge i32 %28, 2
  %30 = add i32 %27, -1
  %31 = select i1 %29, i32 %30, i32 %28
  store i32 %31, ptr getelementptr inbounds nuw (i8, ptr @_anonymous13, i64 4), align 4
  call void @llvm.aie2p.release(i32 51, i32 1)
  %32 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous13, i64 8), align 4
  %33 = add i32 %32, 1
  %34 = icmp sge i32 %33, 2
  %35 = add i32 %32, -1
  %36 = select i1 %34, i32 %35, i32 %33
  store i32 %36, ptr getelementptr inbounds nuw (i8, ptr @_anonymous13, i64 8), align 4
  %37 = add i64 %14, 1
  br label %13

38:                                               ; preds = %13
  call void @llvm.aie2p.release(i32 4, i32 1)
  %39 = load i32, ptr @_anonymous13, align 4
  %40 = add i32 %39, 1
  %41 = icmp sge i32 %40, 2
  %42 = add i32 %39, -1
  %43 = select i1 %41, i32 %42, i32 %40
  store i32 %43, ptr @_anonymous13, align 4
  %44 = add i64 %5, 1
  br label %4
...
48:                                               ; preds = %7
  %49 = phi ptr [ @inter_1_buff_0, %7 ]
  br label %9

50:                                               ; preds = %7
  %51 = phi ptr [ @inter_1_buff_1, %7 ]
  br label %9

52:                                               ; preds = %16
  %53 = phi ptr [ @Adp_1_cons_buff_0, %16 ]
  br label %18

54:                                               ; preds = %16
  %55 = phi ptr [ @Adp_1_cons_buff_1, %16 ]
  br label %18

56:                                               ; preds = %21
  %57 = phi ptr [ @Cdp_1_buff_0, %21 ]
  br label %23

58:                                               ; preds = %21
  %59 = phi ptr [ @Cdp_1_buff_1, %21 ]
  br label %23
}
