module {
  aie.device(npu2) @op0_LayerFusedMLIR {
    ...
    aie.objectfifo @Aqkv_2(%mem_tile_3_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo @Aqkv_src_1(%shim_noc_tile_1_0, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<4608xui8>> 
    aie.objectfifo @Aqkv_3(%mem_tile_3_1, {%tile_3_2}, 2 : i32) : !aie.objectfifo<memref<2304xui8>> 
    aie.objectfifo.link [@Aqkv_src_1] -> [@Aqkv_2, @Aqkv_3]([] [0, 2304])
    aie.objectfifo @Cdp_0(%tile_0_5, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_1(%tile_1_5, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_2(%tile_2_5, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @Cdp_3(%tile_3_5, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @ffn_out_joined_0(%mem_tile_2_1, {%tile_4_3}, 2 : i32) : !aie.objectfifo<memref<8xbf16>> 
    ...
    aie.objectfifo @anm_in(%shim_noc_tile_4_0, {%tile_4_2}, 2 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @bo_L3L2(%shim_noc_tile_3_0, {%mem_tile_1_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @bo_mem(%mem_tile_1_1, {%tile_0_3, %tile_1_3, %tile_2_3, %tile_3_3}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    ...
    aie.objectfifo @ffi_L3L2(%tile_4_2, {%mem_tile_3_1}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    aie.objectfifo @ffi_mem(%mem_tile_3_1, {%tile_0_4, %tile_1_4, %tile_2_4, %tile_3_4}, 1 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    ...
    aie.objectfifo @rms_in(%shim_noc_tile_3_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<2048xbf16>> 
    ...
    %core_4_3 = aie.core(%tile_4_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4294967295 step %c1_1 {
          ...
          aie.objectfifo.release @inpff_fifo(Consume, 1)
        }
      }
      aie.end
    }
